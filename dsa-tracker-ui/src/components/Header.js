                ...
                <div className='flex flex-row justify-center items-center'>
                    ...
                    {userInfoObj['_id'] === '' ?
                        ...
                        <div>
                            ...
                            {isUserInfoDialogOpen ? <div className='card z-10 absolute right-2 top-2'>
                                <div className='flex flex-row justify-between p-2'>
                                    <span>Welcome user</span>
                                    <svg onClick={toggleUserInfoDialog} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer">
                                ...
                                <div className='flex flex-row px-3 mt-2'>
                                    ...
                                    <div className='flex flex-col'>
                                        <span><strong>{userInfoObj['name']}</strong></span>
