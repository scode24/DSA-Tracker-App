            ...
            <div className='flex flex-col justify-center h-full text-center w-1/4  max-md:w-3/4'>
                ...
                <form id='register-form' className='mt-9 text-left' onSubmit={handleFormSubmit}>
                    ...
                    <div className='flex flex-col mt-3'>
                        ...
                        <input type='password' name='confirm_password' onChange={handleFormInput} />
                    </div>

                    <button className='custom-button w-full mt-5' type='submit'>Sign up</button>
                </form>

                <span className='mt-7'>Already registered ? <Link className='text-indigo-700 font-bold' to='/login'>Sign in here</Link></span>
            </div>
        </div>
    )
}
