...
export const userInfoStore = create((set) => ({
    ...
    setUserInfoObj: (userInfoObj) => set((state) => ({ userInfoObj: userInfoObj }))
}))

export const updateFormDataStore = create((set) => ({
    updateFormDataObj: { _id: '', question: '', link: '', topic: '', complexity: '', note: '', state: '' },
    setUpdateFormDataObj: (updateFormDataObj) => set((state) => ({ updateFormDataObj: updateFormDataObj }))
}))